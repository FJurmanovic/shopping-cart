...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-shelf></app-shelf>";
    /***/
  },
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsShelfShelfComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_shelf_shelf_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/shelf/shelf.component */
    "./src/app/components/shelf/shelf.component.ts");

    var routes = [{
      path: '',
      component: _components_shelf_shelf_component__WEBPACK_IMPORTED_MODULE_3__["ShelfComponent"],
      data: {
        title: 'Shopping Cart'
      }
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_shelf_shelf_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/shelf/shelf.component */
    "./src/app/components/shelf/shelf.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_shelf_shelf_component__WEBPACK_IMPORTED_MODULE_5__["ShelfComponent"]],
  ...
  /***/
  function srcAppComponentsShelfShelfComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsShelfShelfComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShelfComponent", function () {
    ...
    /*#__PURE__*/
    function () {
      function ShelfComponent(httpService) {
        _classCallCheck(this, ShelfComponent);
      ...
      _createClass(ShelfComponent, [{
        key: "toggleSide",
        value: function toggleSide() {
          var side = document.getElementById("side");
          var toggle = document.getElementById("toggle");
          var div0 = toggle.getElementsByTagName("div")[0];
        ...
        key: "toCart",
        value: function toCart(id) {
          if (this.inCart.filter(function (obj) {
            return obj.id === id;
          }).length > 0) {
            this.inCart.find(function (x) {
              return x.id == id;
            }).count++;
          } else {
            this.inCart.push({
              ...
              image: this.products[id - 1].image,
              price: this.products[id - 1].price["amount"],
              count: 1
            });
          }

          this.sum += this.inCart.find(function (x) {
            return x.id == id;
          }).price;
        }
      }, {
        key: "addCount",
        value: function addCount(id) {
          this.inCart.find(function (x) {
            return x.id == id;
          }).count++;
          this.sum += this.inCart.find(function (x) {
        ...
        key: "remCount",
        value: function remCount(id) {
          if (this.inCart.find(function (x) {
            return x.id == id;
          }).count <= 1) {
            this.sum -= this.inCart.find(function (x) {
              return x.id == id;
            }).price;
            this.inCart.splice(this.inCart.findIndex(function (x) {
              return x.id == id;
            }), 1);
          } else if (this.inCart.find(function (x) {
            return x.id == id;
          }).count > 0) {
            this.inCart.find(function (x) {
              return x.id == id;
        ...
        key: "remProd",
        value: function remProd(id) {
          this.sum -= this.inCart.find(function (x) {
            return x.id == id;
          }).price * this.inCart.find(function (x) {
            return x.id == id;
          }).count;
          this.inCart.splice(this.inCart.findIndex(function (x) {
            return x.id == id;
        ...
        value: function ngOnInit() {
          ...
          this.httpService.get('./assets/products.json').subscribe(function (data) {
            _this.productsObject = data;
            console.log(_this.productsObject);
            _this.products = _this.productsObject["products"];
    ...
    ShelfComponent.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    ShelfComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-shelf',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./shelf.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/shelf/shelf.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./shelf.component.scss */
      "./src/app/components/shelf/shelf.component.scss")).default]
    })], ShelfComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\repos\github.com\Yurma\shopping-cart\src\main.ts */
    "./src/main.ts");
    /***/
  }
